package com.smu.user.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("USER SERVICE FOR SMU SYSTEM")
                .version("1.0.0")
                .contact(contact)
                .description("USER SERVICE FOR SMU SYSTEM")

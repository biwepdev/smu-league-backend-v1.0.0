package com.smu.Role.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("ROLE SERVICE FOR SMU SYSTEM")
                .version("1.0.0")
                .contact(contact)
                .description("ROLE SERVICE FOR SMU SYSTEM")

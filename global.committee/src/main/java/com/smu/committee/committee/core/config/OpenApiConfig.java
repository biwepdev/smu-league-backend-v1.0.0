package com.smu.committee.committee.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("COMMITTEE SERVICE FOR SMU SYSTEM")
                .version("1.0.0")
                .contact(contact)
                .description("COMMITTEE SERVICE FOR SMU SYSTEM")
